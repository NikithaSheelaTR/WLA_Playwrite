namespace WestlawAdvantage.Tests
{
    ...
    [TestClass]
    public class WlaBaseTest : BaseWebUiTest
    {
        protected const string CurrentTestCategory = "WestlawAdvantage";
        protected const string SmokeTestCategory = "AdvantageSmoke";
        protected const string TeamDahlCategory = "TeamDahlTests";
        protected const string TeamSahniCategory = "TeamSahniAdvantageTests";
        ...
        protected const string F1HomePageLink = "/Advantage/Home?transitionType=Default&contextData=(sc.Default)&bhcp=1&firstPage=true";

        /// <summary>
        /// Initializes a new instance of the <see cref="WlaBaseTest"/> class.
        /// </summary>
        public WlaBaseTest()
        {
        ...
        /// </value>
        protected string FolderToSave => Path.Combine(FolderToSaveConst, this.TestContext.TestName);
