...
{
    [TestClass]
    public class CompanyDealsOpportunityFinderPrivateOnly : BaseOpportunityFinderTest
    {
        [TestMethod]
        [TestCategory(CurrentTestCategory)]
        public void OpportunityFinderDealsDownloadReportCancelButtonTest()
        {
            const string DownloadDialogCancelButtonVerify = "Verify: Cancel button closed download dialog";

            var opportunityFinderPage = this.SelectMergersAndAcquisitions(OpportunityFinderCompanydropdownItems.PrivateOnly);
            ...
            filterDialog.EnterSearchQuery("Engineering, Accounting, Research, Management, And Related Services");
        ...
        [TestMethod]
        [TestCategory(CurrentTestCategory)]
        public void OpportunityFinderDealsDownloadReportTest()
        {
        ...
        [TestMethod]
        [TestCategory(CurrentTestCategory)]
        public void OpportunityFinderDealsPrivateOnlyWebsiteURLTest()
        {
            const string WebsiteUrlVerify = "Verify that website URL is displayed";
        ...
        [TestMethod]
        [TestCategory(CurrentTestCategory)]
        public void OpportunityFinderDealsPrivateOnlyDisplayPerPageTest()
        {
