namespace WestlawPrecision.Tests.SeparateAthensFeature.ResponsivePrecision
{
    ...
    public class PrecisionResponsiveBaseTest : BaseWebUiTest
    {
        protected const string CurrentTestCategory = "ResponsivePrecision";

        /// <summary>
        /// Initializes a new instance of the <see cref="PrecisionResponsiveBaseTest"/> class.
        /// </summary>
        public PrecisionResponsiveBaseTest()
        {
        ...
        /// <summary>
        /// Switch content type and run search
        /// </summary>
        /// <returns> The <see cref="PrecisionCommonSearchResultPage"/>. </returns>
        protected PrecisionCommonSearchResultPage SwitchContentTypeAndRunSearch(ContentType contentType, string query)
        {
            var homePage = this.GetHomePage<PrecisionHomePage>();
            homePage = homePage.Header.OpenJurisdictionDialog().SelectDefaultJurisdiction().ClickSelectButton<PrecisionHomePage>();
            var searchResultsPage = homePage.Header.EnterSearchQueryAndClickSearch<PrecisionCommonSearchResultPage>(query);
            searchResultsPage.NarrowTabPanel.SetActiveTab<ContentTypesTabComponent>(NarrowTab.ContentTypes).ContentType.SetDefaultContentType(contentType);
            return searchResultsPage.Header.EnterSearchQueryAndClickSearch<PrecisionCommonSearchResultPage>(query);
        }
        ...
        /// <summary>
        /// Go to Precision home page by clicking home logo
        /// </summary>
        protected void GoToPrecisionHomePage()
        {
            var homePage = this.GetHomePage<PrecisionHomePage>();
            ...
            homePage.Header.ClickLogo<PrecisionHomePage>();
        }
        ...
        /// <summary>
        /// Delete all outlines if present
        /// </summary>
        protected EdgeCommonDocumentPage DeleteAllOutlines(EdgeCommonDocumentPage document)
        {
        ...
        /// Add an outline
        /// </summary>
        protected EdgeCommonDocumentPage AddOutline(EdgeCommonDocumentPage document,string outlineTitle)
        {
            document = document.RightPanel.OutlineBuilderPanel.OutlineBuilderRightPanel
                     .CreateNewOutlineButton.Click<EdgeCommonDocumentPage>();
            SafeMethodExecutor.WaitUntil(() => document.RightPanel.OutlineBuilderPanel.OutlineBuilderRightPanel
                   .EditOutlineTitleButton.Displayed);
            document = document.RightPanel.OutlineBuilderPanel.OutlineBuilderRightPanel
                   .EditOutlineTitleButton.Click<EdgeCommonDocumentPage>().RightPanel.OutlineBuilderPanel
                   .OutlineBuilderRightPanel.CurrentOutlineTextbox.SetText<EdgeCommonDocumentPage>(outlineTitle + Keys.Enter);
            return document;
        }
    }
}