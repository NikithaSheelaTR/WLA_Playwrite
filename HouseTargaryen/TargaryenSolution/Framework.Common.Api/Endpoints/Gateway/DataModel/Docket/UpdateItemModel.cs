namespace Framework.Common.Api.Endpoints.Gateway.DataModel.Docket
{
    ...
    public class UpdateItemModel
    {
        ...
        public UpdatePayloadModel RequestPayload { get; set; }
        ...
        /// <summary>
        /// Gets or sets the billable page count.
        /// </summary>
        [JsonProperty("billablePageCount")]
        public string BillablePageCount { get; set; }
