namespace Framework.Common.Api.Tests
{
    ...
    /// <summary>
    /// The base API regression test (without dependency on QRT)
    /// </summary>
    /// <typeparam name="TTestContextType"></typeparam>
    public class BaseApiTest<TTestContextType> : BaseContextualTest<TTestContextType> where TTestContextType : ApiTestExecutionContext
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes new instance of <see cref="BaseApiTest{TTestContextType}"/>
        /// </summary>
        public BaseApiTest()
        {
        ...
        public override void InitializeTestCase()
        {
            ...
            this.TestCaseVerify = new TestCaseVerify();
            this.TestCaseAssert = new TestCaseAssert();
        ...
        protected void DisplayPasswordInfo()
        {
            foreach (IUserInfo userInfo in CredentialPool.GetAllRegisteredUsers())
            {
                ...
                if (userDbInfo != null)
                {
                    ...
                    BaseApiTest<TTestContextType>.PrintPasswordInfo(userDbInfo.PasswordInfo);
                }
                else
                {
