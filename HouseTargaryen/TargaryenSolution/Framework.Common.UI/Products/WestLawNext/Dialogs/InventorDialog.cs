namespace Framework.Common.UI.Products.WestLawNext.Dialogs
{
    ...
    /// <summary>
    ///  Describe  dialog which appears after clicking on the 'Select' button  on the Inventor Facet
    /// </summary>
    public class InventorDialog : BaseAvailableAndSelectedOptionsListsDialog
    {
        private static readonly By ContainerLocator = By.Id("co_facet_ipInventor_popup");
