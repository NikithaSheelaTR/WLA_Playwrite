namespace Framework.Common.UI.Products.WestLawNextCanada.Utils
{
    ...
    /// <summary>
    /// The Westlaw Canada Aws sign on manager.
    /// </summary>
    public class WestlawCanadaAwsSignOnManager : SignOnManagerWithRouting
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ICreatablePageObject SignOff()
        {
            SafeMethodExecutor.Execute(
                () => new ProfileSettingsDialog().ClickSignOff()).LogDetails();
        ...
        /// <summary>
        /// Signs on to Westlaw Canada AWS using the specified context.
        /// </summary>
        ...
        public override TPage SignOn<TPage, TSignOnContext>(TSignOnContext signOnContext)
        {
            ...
            {
                string westLawNextCanadaUrl = TestConfigurationRepository.DefaultInstance.FindEndpoint(
