namespace Framework.Common.UI.Products.WestlawEdgePremium.Components.AALP.CoCounsel
{
    ...
    /// <summary>
    /// CoCounselQuickCheckUploadDocumentDialog
    /// </summary>
    public class CoCounselQuickCheckUploadDocumentDialog : BaseModuleRegressionDialog
    {
        ...
        private static readonly By DoneButtonLocator = By.XPath(".//*[@aria-describedby='done-button-description']");
