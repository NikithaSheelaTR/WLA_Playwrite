namespace Framework.Common.UI.Products.WestlawEdgePremium.Dialogs.NarrowPane.Facets
{
    ...
    /// </summary>
    public class RiCitingProximityMoreInfoDialog : BaseModuleRegressionDialog
    {
        ...
        private IWebElement Container =>
            DriverExtensions.WaitForElement(
                By.XPath(
                    EnumPropertyModelCache.GetMap<Dialogs, WebElementInfo>()[Dialogs.
                                              CitingProximityMoreInfoDialog]
                                          .LocatorString));
    }
}