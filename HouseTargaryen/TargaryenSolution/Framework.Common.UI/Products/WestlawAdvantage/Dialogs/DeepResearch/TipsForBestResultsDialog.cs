namespace Framework.Common.UI.Products.WestlawAdvantage.Dialogs.DeepResearch
{
    ...
    {
        private static readonly By ContainerLocator = By.XPath("//*[@data-testid='tips-for-best-results-dialog']");
        private static readonly By CloseButonLocator = By.XPath(".//saf-button-v3[@data-testid='tips-for-best-results-close']");
