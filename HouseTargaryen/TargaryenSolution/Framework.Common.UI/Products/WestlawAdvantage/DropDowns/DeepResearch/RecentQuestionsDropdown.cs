namespace Framework.Common.UI.Products.WestlawAdvantage.DropDowns.DeepResearch
{
    ...
    {
        private static readonly By DropdownLocator = By.XPath("//div[contains(@class, 'Input-module__recentSearchesContainerWrapper')]");
        private static readonly By RecentQuestionLocator = By.XPath(".//*[contains(@class,'RecentSearches-module__recentSearchesMenu')]//saf-menu-item-v3");
        private static readonly By RecentQuestionsButtonLocator = By.XPath(".//saf-button-v3[@id='recent-searches-menu-trigger']");
